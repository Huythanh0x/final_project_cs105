...
function init() {
    // init scene geometry, material, mesh, background, gridHelper, pointLight, GUI
    ...
    $(".geometry").click(function () {
        ...
        //remove an old geometry and create a new one with name "geometry"
    ...
    $(".surface").click(function () {
        ...
        //create new texture from clicked button and keep the old color options
